...
var x=['./pages/home/home.wxml','./pages/index/index.wxml'];d_[x[0]]={}
...
_(xC,oD)
_(oB,xC)
var fE=_mz(z,'input',['bindinput',2,'data-event-opts',1,'value',2],[],e,s,gg)
_(oB,fE)
_(r,oB)
return r
}
...
var oH=_mz(z,'swiper',['autoplay',1,'class',1,'duration',2,'indicatorDots',3,'interval',4],[],e,s,gg)
...
_(oH,bO)
_(hG,oH)
var oR=_mz(z,'image',['class',12,'src',1],[],e,s,gg)
_(hG,oR)
var fS=_n('view')
